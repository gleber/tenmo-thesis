...
INSERT INTO public.graph VALUES ('ssh-remote-docker-stop-1', 'child_of', 'ssh-remote-1', '{}') ON CONFLICT DO NOTHING;
INSERT INTO public.graph VALUES ('ssh-remote-1', 'parent_of', 'ssh-remote-docker-stop-1', '{}') ON CONFLICT DO NOTHING;
...
INSERT INTO public.graph VALUES ('ssh-remote-docker-run-1', 'child_of', 'deploy-script.sh-run-1', '{}') ON CONFLICT DO NOTHING;
INSERT INTO public.graph VALUES ('deploy-script.sh-run-1', 'parent_of', 'ssh-remote-docker-run-1', '{}') ON CONFLICT DO NOTHING;
